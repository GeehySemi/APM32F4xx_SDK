...
int main(void)
{
    ...
    LOG_Print("IWDT is running, if press KEY2 to start feed watchdog, Ohterwise System will reset about 4 seconds!\r\n");
    ...
    while (1)
    {
        if(bKEY1_Flag == 1)
        {
            ...
            IWDT_Refresh();
            LOG_Print("\r\nif press KEY2 again to finish feeding watchdog, System will reset about 4 seconds!\r\n");
        }
        else
        {
            BOARD_LEDOff(LED2);
