...
int main(void)
{
    ...
    /* TMR1 frequency = 240MHz/2*(119 + 1) = 1MHz */
    TMR_TimeBaseStruct.period = 119;
    TMR_ConfigTimeBase(TMR1, &TMR_TimeBaseStruct);

    /* TMR2 frequency = 120MHz/2*(83 + 1) = 500KHz */
    TMR_TimeBaseStruct.period = 119;
    TMR_ConfigTimeBase(TMR2, &TMR_TimeBaseStruct);

    /* TMR3 frequency = 120MHz/2*(239 + 1) = 250KHz */
    TMR_TimeBaseStruct.period = 239;
