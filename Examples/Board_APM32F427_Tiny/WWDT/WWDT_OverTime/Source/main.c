...
int main(void)
{
    ...
    printf("\r\n System reset \r\n");
    printf("\r\n The overtime is from 25.38ms to 34.56ms \r\n");
    ...
    while (1)
    {
        if (is_OverTime == RESET)
        {
            ...
            /* Delay 30ms , 25.38<30<34.56 ,Refresh allowed, system still running */
            BOARD_DelayMs(30);
        ...
        if (is_OverTime == SET)
        {
            ...
            /* Delay 40ms  ,34.56<40 ,Refresh not allowed, system reset */
            BOARD_DelayMs(40);
