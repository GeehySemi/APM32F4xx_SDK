...
#define TIME1 CAN_TIME_SEGMENT1_3
#define TIME2 CAN_TIME_SEGMENT2_4
#define PRES  15
...
int main(void)
{
    ...
    {
        state = 0x01;
        LOGI(tag, "> CAN polling test passed !\r\n");
    }
    else
    {
        state = 0x00;
        LOGI(tag, "> CAN polling test failed !\r\n");
    }
#endif

#if defined(CAN_TEST_INT)
    LOGI(tag, " ********** CAN Interrupt Test ********** \r\n");
    ...
    {
        state |= 0x02;
        LOGI(tag, "> CAN interrupt test passed !\r\n");
    }
    else
    {
        LOGI(tag, "> CAN interrupt test failed !\r\n");
    }
#endif
...
void CAN_GPIOInit(void)
{
    ...
    GPIO_ConfigPinAF(GPIOD, GPIO_PIN_SOURCE_0, GPIO_AF_CAN1);
    GPIO_ConfigPinAF(GPIOD, GPIO_PIN_SOURCE_1, GPIO_AF_CAN1);
