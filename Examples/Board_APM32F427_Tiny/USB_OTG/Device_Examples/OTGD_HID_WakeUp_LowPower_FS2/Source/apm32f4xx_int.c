...
/*!
 * @brief   This function handles USB FS2 wakeup Handler
 *
 * @param   None
 *
 * @retval  None
 *
 */
void OTG_FS2_WKUP_IRQHandler(void)
{
...
/*!
 * @brief   This function handles USB FS2 Handler
 *
 * @param   None
 *
 * @retval  None
...
/*!
 * @brief   This function handles EINT9_5 Handler
 *
 * @param   None
 *
 * @retval  None
...
void EINT9_5_IRQHandler(void)
{
    if(EINT_ReadIntFlag(EINT_LINE_9))
    {
        ...
        /*Clear EINT_LINE9 interrupt flag*/
