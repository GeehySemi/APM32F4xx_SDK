...
int main(void)
{
    ...
    BOARD_LCDPrintString(30, 40, "This is a ETH Server Demo!", LCD_COLOR_USER);
    ...
    printf("\n\rKEY1: create TCP server\n");
    printf("KEY2: close TCP server\n");

    BOARD_LCDPrintString(30, 240, "KEY1: create TCP server", LCD_COLOR_USER);
    BOARD_LCDPrintString(30, 280, "KEY2: close TCP server", LCD_COLOR_USER);
