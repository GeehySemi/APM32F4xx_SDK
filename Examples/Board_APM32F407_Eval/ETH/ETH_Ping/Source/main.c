...
int main(void)
{
    ...
    BOARD_LCDPrintString(30, 80, "  Static IP address  ", LCD_COLOR_USER);
    BOARD_LCDPrintString(30, 120, "IP: 192,168,73,22\n", LCD_COLOR_USER);
    BOARD_LCDPrintString(30, 160, "NETMASK: 255,255,255,0\n", LCD_COLOR_USER);
    BOARD_LCDPrintString(30, 200, "Gateway: 192,168,73,1\n", LCD_COLOR_USER);
