...
The program aims to show how to use interrupt to send or received data by using USART, in this case,
...
&par Directory contents
  ...
  - USART/USART_Interrupt/Source/apm32f4xx_int.c     Interrupt handlers
