                                  ...
                                  uint16_t blockLength)
{
    ...
    BOARD_W25QXXReadData(buffer, blockAddr * w25qxxInfo.sectorSize, blockLength * w25qxxInfo.sectorSize);
                                   ...
                                   uint16_t blockLength)
{
    ...
    BOARD_W25QXXWriteData(buffer, blockAddr * w25qxxInfo.sectorSize, blockLength * w25qxxInfo.sectorSize);
