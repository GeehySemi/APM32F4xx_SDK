...
void USB_DeviceInit(void)
{
    ...
    if(USBD_Init(&gUsbDeviceHS, USBD_SPEED_HS, &USBD_DESC_HS, &USBD_COMPOSITE_CLASS, USB_DevUserHandler) == USBD_OK)
    {
        /* USB composite init */
        USBD_Composite_Init(&gUsbDeviceHS, &USBD_WINUSB_INTERFACE_HS, &USBD_CUSTOM_HID_INTERFACE_HS);
    }
}
...
void USB_DeviceReset(void)
{
    ...
    USBD_Composite_Deinit(&gUsbDeviceHS);
}
