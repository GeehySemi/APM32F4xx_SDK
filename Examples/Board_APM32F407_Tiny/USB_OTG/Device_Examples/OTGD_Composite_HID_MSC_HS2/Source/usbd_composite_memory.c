...
static uint8_t USBD_HS_MemoryReadMaxLun(void);
static USBD_STA_T USBD_HS_MemoryCheckWPR(uint8_t lun);
static USBD_STA_T USBD_HS_MemoryCheckReady(uint8_t lun);
static USBD_STA_T USBD_HS_MemoryInit(uint8_t lun);
static USBD_STA_T USBD_HS_MemoryReadCapacity(uint8_t lun, uint32_t* blockNum, \
                                             uint16_t* blockSize);
static USBD_STA_T USBD_HS_MemoryReadData(uint8_t lun, uint8_t* buffer, uint32_t blockAddr, \
                                         uint16_t blockLength);
static USBD_STA_T USBD_HS_MemoryWriteData(uint8_t lun, uint8_t* buffer, uint32_t blockAddr, \
                                          uint16_t blockLength);
