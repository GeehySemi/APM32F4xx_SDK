...
void USB_DevUserApplication(void)
{
    ...
    {
        case USER_APP_INIT:
            interval = USBD_Composite_CDC_ReadInterval(&gUsbDeviceHS);
        ...
        case USER_APP_RUN:
            if(gUsbDeviceHS.devState == USBD_DEV_CONFIGURE)
            {
                ...
                if(gCDCVCP[CDC1].state == USBD_CDC_VCP_REV_UPDATE)
                {
                    ...
                    USBD_HS_CDC_ItfSend((uint8_t *)cdcRxBuffer[CDC1], (uint16_t)gCDCVCP[CDC1].rxUpdateLen, CDC1);
                ...
                if(gCDCVCP[CDC2].state == USBD_CDC_VCP_REV_UPDATE)
                {
                    ...
                    USBD_HS_CDC_ItfSend((uint8_t *)cdcRxBuffer[CDC2], (uint16_t)gCDCVCP[CDC2].rxUpdateLen, CDC2);
