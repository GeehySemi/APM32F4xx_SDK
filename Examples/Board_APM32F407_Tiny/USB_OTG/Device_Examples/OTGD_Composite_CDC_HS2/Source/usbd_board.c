...
void USBD_HardwareInit(USBD_INFO_T* usbInfo)
{
    ...
    if (usbInfo->devSpeed == USBD_SPEED_HS)
    {
        ...
        /* Configure TX FIFO */
        USBD_OTG_ConfigDeviceTxFifo(&usbDeviceHandler, 0, USBD_HS_EP0_FIFO_SIZE);
        USBD_OTG_ConfigDeviceTxFifo(&usbDeviceHandler, 1, USBD_HS_EP1_FIFO_SIZE);
        USBD_OTG_ConfigDeviceTxFifo(&usbDeviceHandler, 2, USBD_HS_EP2_FIFO_SIZE);
        USBD_OTG_ConfigDeviceTxFifo(&usbDeviceHandler, 3, USBD_HS_EP3_FIFO_SIZE);
