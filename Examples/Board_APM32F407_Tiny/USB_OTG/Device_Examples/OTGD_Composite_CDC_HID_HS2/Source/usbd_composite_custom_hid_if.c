...
static USBD_STA_T USBD_HS_CUSTOM_HID_ItfInit(void);
static USBD_STA_T USBD_HS_CUSTOM_HID_ItfDeInit(void);
static USBD_STA_T USBD_HS_CUSTOM_HID_ItfSendReport(uint8_t *buffer, uint8_t length);
static USBD_STA_T USBD_HS_CUSTOM_HID_ItfReceive(uint8_t *buffer, uint8_t *length);
...
{
    "Custom HID Keyboard Interface HS",
...
static USBD_STA_T USBD_HS_CUSTOM_HID_ItfSendReport(uint8_t *buffer, uint8_t length)
{
    ...
    usbStatus = USBD_Composite_CUSTOM_HID_TxReport(&gUsbDeviceHS, buffer, length);
...
static USBD_STA_T USBD_HS_CUSTOM_HID_ItfReceive(uint8_t *buffer, uint8_t *length)
{
    ...
    USBD_Composite_CUSTOM_HID_RxPacket(&gUsbDeviceHS);
