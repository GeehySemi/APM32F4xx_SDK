...
void EINT10_IRQRequest(void)
{
    if(EINT_ReadStatusFlag(KEY1_BUTTON_EINT_LINE) == SET)
    {
        ...
        while(1)
        {
            ...
            printf("working in EINT15_10_IRQHandler\r\n");
            printf("give PA0 a falling edge signal to enter higher interrupt.\r\n\r\n");
        }
    }
}
