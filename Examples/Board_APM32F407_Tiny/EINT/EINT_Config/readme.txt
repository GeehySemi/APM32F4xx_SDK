...
In this example, 2 EINT lines (KEY1,KEY2) when using the BOARD
...
In this example
    - EINT11 is mapped to PC11(KEY2)
    - EINT10 is mapped to PC10(KEY1)

After EINT configuration
  when falling edge is detected on EINT11 , LED2 toggles
