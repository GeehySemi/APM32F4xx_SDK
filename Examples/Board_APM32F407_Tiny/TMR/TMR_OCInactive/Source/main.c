...
int main(void)
{
    ...
    GPIO_ConfigStruct.pin = GPIO_PIN_6| GPIO_PIN_7| GPIO_PIN_0| GPIO_PIN_1;
    ...
    /* Config GPIO */
    GPIO_ConfigStruct.pin = GPIO_PIN_5| GPIO_PIN_6| GPIO_PIN_3|GPIO_PIN_4;
    ...
    GPIO_WriteBitValue(GPIOA, GPIO_PIN_6, 1);
    GPIO_WriteBitValue(GPIOA, GPIO_PIN_5, 1);
