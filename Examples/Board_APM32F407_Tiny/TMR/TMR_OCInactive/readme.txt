...
mode.
  ...
  - TMR3CLK = SystemCoreClock/2 = 84MHz.Prescaler = 83, TMR counter clock = 1 MHz
...
the PA5, PA6, PA3, and PA4  are set. 

When the counter value reaches the Output compare registers values,
the PA5, PA6, PA3, and PA4  are reset.

The CHx delay correspond to the time difference between PAx rising edges and falling edge.
Reset system and display PA5, PA6, PA3, and PA4 waveform by oscilloscope.

&par Hardware Description

  - using PA5, PA6, PA3, and PA4 to output signal.

&par Directory contents

  - TMR/TMR_OCInactive/Source/apm32f4xx_int.c        Interrupt handlers
