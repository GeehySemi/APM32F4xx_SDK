...
APM32F411 TINY Devices:
  ...
  - TMR4CLK = SystemCoreClock/2 = 60MHz.Prescaler = 0, TMR counter clock = 60MHz

  - The TMR4 CC1 register = 60MHz/5000
  - CC1 update rate = 5KHz
  - Channel 1 waveform frequency = 2.5KHz

  - The TMR4 CC2 register = 60MHz/10000
  - CC2 update rate = 10KHz
  - Channel 2 waveform frequency = 5KHz

  - The TMR4 CC3 register = 60MHz/50000
  - CC3 update rate = 50KHz
  - Channel 3 waveform frequency = 25KHz

  - The TMR4 CC4 register = 60MHz/100000
