 ...
 * @file        sdio.h
 *
 * @brief       Header for sdio.c module
 *
 * @version     V1.0.0
 *
 * @date        2025-02-15
...
typedef enum
{
    ...
    SD_BLOCK_LEN_ERR                   = (10), /*!< Transferred block length is not allowed for the card 
                                                    or the number of transferred bytes does not match the block length */
    SD_ERASE_SEQ_ERR                   = (11), /*!< An error in the sequence of erase command occurs */
    SD_BAD_ERASE_PARAM                 = (12), /*!< An Invalid selection for erase groups */
    SD_WRITE_PROT_VIOLATION            = (13), /*!< Attempt to program a write protect block */
    SD_LOCK_UNLOCK_FAILED              = (14), /*!< Sequence or password error has been detected in unlock 
    ...
    SD_ERASE_RESET                     = (25), /*!< Erase sequence was cleared before executing because an out of 
...
#define SDIO_DATATIMEOUT                ((uint32_t)0x0000FFFF)
