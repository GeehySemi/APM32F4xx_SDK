...
- Load the binary image of the user file that needs to be upgraded into the
  ...
  address of the upgrade file must be set correctly (0x800F000).
...
Flash space:
0x08000000 - 0x0800EFFF : USB FW upgrade bootloader
0x0800F000 - 0x0801FFFF : USB FW upgrade application
