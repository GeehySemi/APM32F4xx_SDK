...
void DCI_Init(void)
{
    ...
    gpioConfigStruct.pin = DCI_D5_PIN | DCI_D6_PIN | DCI_D7_PIN | DCI_VSYNC_PIN;
    GPIO_Config(GPIOB, &gpioConfigStruct);

    gpioConfigStruct.pin = DCI_D0_PIN | DCI_D1_PIN | DCI_D2_PIN | DCI_D3_PIN | DCI_D4_PIN;
    ...
    /* PC11,AF13 DCI_D4 */
    GPIO_ConfigPinAF(GPIOC,GPIO_PIN_SOURCE_11,GPIO_AF_DCI);
    /* PB6,AF13  DCI_D5 */
    GPIO_ConfigPinAF(GPIOB,GPIO_PIN_SOURCE_6,GPIO_AF_DCI);
    /* PB8,AF13  DCI_D6 */
    GPIO_ConfigPinAF(GPIOB,GPIO_PIN_SOURCE_8,GPIO_AF_DCI);
    /* PB9,AF13  DCI_D7 */
    GPIO_ConfigPinAF(GPIOB,GPIO_PIN_SOURCE_9,GPIO_AF_DCI);
    ...
    NVIC_EnableIRQRequest(DCI_IRQn, 1, 0);
