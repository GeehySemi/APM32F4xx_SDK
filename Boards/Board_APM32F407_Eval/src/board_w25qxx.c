 ...
 * @retval  flash ID
 */
uint16_t BOARD_W25QXXReadFlashID(void)
{
    uint16_t id = 0U;
 ...
 * @retval  None
 */
void BOARD_W25QXXReadData(uint8_t* buffer,uint32_t addr,uint16_t length)
{ 
    uint16_t i;
 ...
 * @retval  None
 */
void BOARD_W25QXXWriteData(uint8_t* buffer,uint32_t addr,uint16_t length)
{
    ...
    while(1)
    {
        ...
        BOARD_W25QXXReadData(writeBuffer,sectorAddr * W25QXX_SECTOR_SIZE, W25QXX_SECTOR_SIZE);
        ...
        if(i < sectorRemain)
        {
            BOARD_W25QXXEraseSector(sectorAddr);
 ...
 * @retval  None
 */
void BOARD_W25QXXEraseChip(void)
{
    W25QXX_EnableWrite();
    W25QXX_WaitBusy();
    W25QXX_CS_Enable();
 ...
 * @retval  None
 */
void BOARD_W25QXXEraseSector(uint32_t addr)
{
 ...
 * @retval  None
 */
void BOARD_W25QXXPowerDown(void)
{
    W25QXX_CS_Enable();
 ...
 *          1 block = 16 sector
 */
void BOARD_W25QXXInit(W25QXX_TYPE_T type)
{
    uint8_t addrMode = 0U;
    ...
    w25qxxInfo.flashID = BOARD_W25QXXReadFlashID();
