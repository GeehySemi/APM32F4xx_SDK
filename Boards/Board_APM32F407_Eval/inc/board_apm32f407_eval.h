...
#define COM2_TX_PIN_SOURCE          GPIO_PIN_SOURCE_2
#define COM2_TX_GPIO_CLK            RCM_AHB1_PERIPH_GPIOA
#define COM2_RX_PIN                 GPIO_PIN_3
#define COM2_RX_GPIO_PORT           GPIOA
#define COM2_RX_GPIO_CLK            RCM_AHB1_PERIPH_GPIOA
#define COM2_RX_PIN_SOURCE          GPIO_PIN_SOURCE_3
#define COM2_IRQn                   USART2_IRQn
#define COM2_GPIO_AF                GPIO_AF_USART2

/**
 * @brief Definition for COM port3, connected to USART3
 */
#define COM3_PORT                   USART3
#define COM3_CLK                    RCM_APB1_PERIPH_USART3
#define COM3_TX_PIN                 GPIO_PIN_10
#define COM3_TX_GPIO_PORT           GPIOB
#define COM3_TX_PIN_SOURCE          GPIO_PIN_SOURCE_10
#define COM3_TX_GPIO_CLK            RCM_AHB1_PERIPH_GPIOB
#define COM3_RX_PIN                 GPIO_PIN_11
#define COM3_RX_GPIO_PORT           GPIOB
#define COM3_RX_GPIO_CLK            RCM_AHB1_PERIPH_GPIOB
#define COM3_RX_PIN_SOURCE          GPIO_PIN_SOURCE_11
#define COM3_IRQn                   USART3_IRQn
#define COM3_GPIO_AF                GPIO_AF_USART3
...
#define BUZZER_GPIO_CLK             RCM_AHB1_PERIPH_GPIOG
