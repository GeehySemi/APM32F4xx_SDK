 ...
 * @file        apm32f423xx.h
 *
 * @brief       CMSIS APM32F423xx Device Peripheral Access Layer Header File.
 *
...
#ifndef __APM32F423XX_H
#define __APM32F423XX_H
...
typedef enum IRQn
{
    ...
    OTG_FS_WKUP_IRQn            = 42,     /*!< OTG_FS1 Wakeup through EINT line interrupt                        */
    ...
    OTG_FS_IRQn                 = 67,     /*!< OTG_FS1 global Interrupt                                          */
    ...
    OTG_FS2_WKUP_IRQn           = 85,     /*!< OTG_FS2 Wakeup through EINT line interrupt                        */
    OTG_FS2_IRQn                = 86,     /*!< OTG_FS2 global Interrupt                                          */
    QSPI_IRQn                   = 87      /*!< QSPI global interrupt                                             */
} IRQn_Type;
...
typedef struct
{
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t WAITP                      : 7;
            __IM  uint32_t RESERVED1                  : 1;
            __IOM uint32_t PREFEN                     : 1;
            __IOM uint32_t ICACHEEN                   : 1;
            __IOM uint32_t DCACHEEN                   : 1;
            __IOM uint32_t ICACHERST                  : 1;
            __IOM uint32_t DCACHERST                  : 1;
            __IM  uint32_t RESERVED2                  : 2;
            __IOM uint32_t PREF_TIMING                : 1;
            __IOM uint32_t RD_INT_EN                  : 1;
            __IOM uint32_t RD_INT_TIMING              : 1;
            __IOM uint32_t PIL                        : 2;
...
typedef struct
{
    ...
    /** Over Sampling Control register*/
    union
    {
        __IOM uint32_t OSAMPCTRL;

        struct
        {
            __IOM uint32_t OSEN           : 1;
            __IOM uint32_t OSR            : 3;
            __IOM uint32_t OSS            : 4;
            __IOM uint32_t TOS            : 1;
        } OSAMPCTRL_B;
    };
} ADC_T;
...
typedef struct
{
    ...
    union
    {
        __IOM uint32_t XIP_INCR_INST;

        struct
        {
            __IOM uint32_t INCR_INST        : 16;
            __IM  uint32_t RESERVED         : 16;
        } XIP_INCR_INST_B;
    };
    ...
    union
    {
        __IOM uint32_t XIP_WRAP_INST;

        struct
        {
            __IOM uint32_t WRAP_INST        : 16;
            __IM  uint32_t RESERVED         : 16;
        } XIP_WRAP_INST_B;
    };
    ...
    union
    {
        __IOM uint32_t XIP_CTRL;

        struct
        {
            __IOM uint32_t FRF              : 2;
            __IOM uint32_t TRANS_TYPE       : 2;
            __IOM uint32_t ADDR_L           : 4;
            __IM  uint32_t RESERVED1        : 1;
            __IOM uint32_t INST_L           : 2;
            __IM  uint32_t RESERVED2        : 2;
            __IOM uint32_t WAIT_CYCLES      : 5;
            __IOM uint32_t DFS_HC           : 1;
            __IM  uint32_t RESERVED3        : 3;
            __IOM uint32_t INST_EN          : 1;
            __IOM uint32_t CONT_XFER_EN     : 1;
            __IM  uint32_t RESERVED4        : 5;
            __IOM uint32_t XIP_PREFETCH_EN  : 1;
            __IM  uint32_t RESERVED5        : 2;
        } XIP_CTRL_B;
    };
    ...
    union
    {
        __IOM uint32_t XIP_SER;

        struct
        {
            __IOM uint32_t SER              : 1;
            __IM  uint32_t RESERVED         : 31;
        } XIP_SER_B;
    };
    ...
    union
    {
        ...
        struct
        {
            ...
            __IOM uint32_t LITTLE_ENDIAN_EN   : 1;
            __IM  uint32_t RESERVED           : 30;
        } SWITCH_B;
    };
    ...
    union
    {
        __IOM uint32_t XIP_EN;

        struct
        {
            __IOM uint32_t XIP_EN          : 1;
            __IM  uint32_t RESERVED        : 31;
        } XIP_EN_B;
    };
} QSPI_T;
...
#define USB_OTG_FS2_BASE        ((uint32_t)0x40040000)
#define USB_OTG_FS2_HOST_BASE   ((uint32_t)USB_OTG_FS2_BASE + 0x400)
#define USB_OTG_FS2_DEV_BASE    ((uint32_t)USB_OTG_FS2_BASE + 0x800)
#define USB_OTG_FS2_FIFO_BASE   ((uint32_t)USB_OTG_FS2_BASE + 0x1000)
#define USB_OTG_FS2_PWR_BASE    ((uint32_t)USB_OTG_FS2_BASE + 0xE00)
...
#define USB_OTG_FS2             ((USB_OTG_GLOBAL_T *)USB_OTG_FS2_BASE)
#define USB_OTG_FS2_H           ((USB_OTG_HOST_T *)USB_OTG_FS2_HOST_BASE)
#define USB_OTG_FS2_D           ((USB_OTG_DEVICE_T *)USB_OTG_FS2_DEV_BASE)

#define USB_OTG_FS_FIFO         ((USB_OTG_FIFO_T *) USB_OTG_FS_FIFO_BASE)
#define USB_OTG_FS2_FIFO        ((USB_OTG_FIFO_T *) USB_OTG_FS2_FIFO_BASE)
#define USB_OTG_FIFO_OFFSET     0x1000

#define USB_OTG_FS_PWR          ((USB_OTG_PWRCLK_T *) USB_OTG_FS_PWR_BASE)
#define USB_OTG_FS2_PWR         ((USB_OTG_PWRCLK_T *) USB_OTG_FS2_PWR_BASE)
