...
typedef enum
{
    ETH_CARRIERSENCE_ENABLE,    /*!< Enable carrier sense during transmission */
...
typedef enum
{
    ...
    ETH_BACKOFFLIMIT_8,     /*!< Set back off limit to 8 */
...
/** ETHERNET MAC address high register bits */
#define ETH_MACA1HR_AE       ((uint32_t)0x80000000)     /*!< Address enable */
#define ETH_MACA1HR_SA       ((uint32_t)0x40000000)     /*!< Source address */
#define ETH_MACA1HR_MBC      ((uint32_t)0x3F000000)     /*!< Mask byte control */
